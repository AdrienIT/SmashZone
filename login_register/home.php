...
<body>
    ...
    <div class="container">
        <div class="d-flex flex-column justify-content-center">
            <h1> <img src=<?php echo $user['pseudo'] . "/" . $user['pseudo'] . ".png" ?> style="overflow:hidden; -webkit-border-radius:50px; -moz-border-radius:50px; border-radius:50px; height:90px; width:90px">
                Bonjour <?php echo $user['prenom'] . " " . $user['nom'] ?></h1>
            <button type="button" onclick="location.href='update.php'" class="btn btn-light col-xl-6 mx-auto justify-content-center mb-4">Editer le profil</button>
            <button type="button" onclick="location.href='avatar.php'" class="btn btn-light col-xl-6 mx-auto justify-content-center mb-4">Changer la photo de
                profil</button>
            <button type="button" onclick="location.href='logout.php'" class="btn btn-light col-xl-6 mx-auto justify-content-center mb-4">Se déconnecter</button>
        </div>
    </div>
</body>
