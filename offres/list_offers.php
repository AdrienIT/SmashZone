...
<body onload="loadNotifi(notifs)">
    ...
    <div class="container">
        ...
        <div class="col-xl text-center">
            ...
            <button onclick="getDepData()" type="button" class="btn btn-primary text-center mb-4">Rechercher</button>
        </div>
                ...
                <div class="row">
                    <div class="card shadow offre text-center">
                        ...
                        <div class="row d-flex justify-content-center">
                            <a type='submit' name='contact' href='../infos_joueur.php?contact=<?php echo $offre['user_id'] ?>' class=' btn btn-primary mr-4'>Voir le profil</a> </td>
                            <a type='submit' name='message' href='../relations/chat_prive.php?message=<?php echo $offre['user_id'] ?>' class=' btn btn-success'>Contacter</a> </td>
                        </div>
                    </div>
                <?php } ?>
                </div>
