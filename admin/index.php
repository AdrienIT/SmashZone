...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark mb-4" style="background-color: #264653; height: 55px;">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03" style="background-color: #264653;">
            ...
            <button class="btn btn-outline-success my-2 my-sm-0 mr-2 ml-auto" onclick="location.href='../club/login.php'" type="button">Connexion
                club</button>
            <button class="btn btn-outline-light my-2 my-sm-0" onclick="location.href='../login_register/login.php'" type="button">Connexion utilisateur</button>
        </div>
    </nav>
