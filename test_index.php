    ...
    <section>
        <div class="slide">
            <div class="content">
                ...
                <p>SmashZone est une référence dans le domaine du tennis, <a href="">Découvrez les dernières nouveautés</a></p>
            </div>
        </div>
        <div class="slide">
            <div class="content">
                <h2>Rencontrez de nouveaux partenaires</h2>
                <p>Cherchez de nouveaux joueurs et organisez des rencontres amicales pour prendre du niveau ! <a href="">Voir les offres</a></p>
            </div>
        </div>
        <div class="slide">
            <div class="content">
                <h2>Triomphez dans les tournois</h2>
                <p>Visitez les tournois organisés pas les clubs, inscrivez vous et rafflez tout sur votre passage ! <a href="">Voir le calendrier des tournois</a></p>
            </div>
        </div>
        <div class="slide">
            <div class="content">
                <h2>Débutez</h2>
                <p>Vous êtes novices et plein d'ambition ? Rechercher le club le plus proche de chez vous et commencez votre carrière ! <a href="">Voir les clubs</a></p>
            </div>
        </div>
        </div>
</body>
